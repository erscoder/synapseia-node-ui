...
use commands::{
    ...
    fetch_chain_info, get_node_logs, get_ui_settings, install_synapseia_node, node_status,
    reap_on_exit, run_command, set_ui_settings, start_node, stop_node, system_info, unlock_wallet,
